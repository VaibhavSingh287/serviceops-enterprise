        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-50 border-b border-slate-200 text-slate-600 font-bold uppercase tracking-wider text-[11px]">
              <tr>
                <th className="p-3.5 whitespace-nowrap">Equipment Asset</th>
                <th className="p-3.5 whitespace-nowrap">Customer & Site</th>
                <th className="p-3.5 whitespace-nowrap">Model / Type</th>
                <th className="p-3.5 whitespace-nowrap">Serial Number</th>
                <th className="p-3.5 text-center whitespace-nowrap">Operating Hours</th>
                <th className="p-3.5 whitespace-nowrap">Last Service</th>
              ...
              {filtered.map((eq) => {
                ...
                return (
                  <tr key={eq.id} className="hover:bg-slate-50">
                    <td className="p-3.5 font-bold text-slate-900 whitespace-nowrap">{eq.name}</td>
                    ...
                    <td className="p-3.5 font-mono text-slate-600 whitespace-nowrap">{eq.serialNumber}</td>
                    <td className="p-3.5 text-center font-mono font-bold text-blue-700 whitespace-nowrap">
                      {eq.operatingHours.toLocaleString()} hrs
                    </td>
                    <td className="p-3.5 text-slate-600 whitespace-nowrap">{eq.lastServiceDate}</td>
